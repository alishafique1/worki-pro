...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'We connect you with a verified local pro, usually within a few hours. Same-day service often available.',
  },
  {
    num: '03',
...
const TRUST_POINTS = [
  ...
  { icon: <Clock3 className="size-5" />, title: 'Fast matching', desc: 'Most homeowners get matched within a few hours. Same-day service often available.' },
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="relative h-56 sm:h-72 overflow-hidden">
        <img
          ...
          alt="Homeowner reviewing service request on phone"
      ...
      <main className="max-w-6xl mx-auto px-6 py-16 space-y-24">
        ...
        <section className="text-center max-w-3xl mx-auto">
          <p className="text-xl text-[#475569] leading-relaxed">
            Get connected to a verified local pro fast — often same day. 100% free for homeowners.
