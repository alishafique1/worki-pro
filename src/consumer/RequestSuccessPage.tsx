    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-[#F8FAFC]">
      <div className="max-w-md bg-white p-12 rounded-[40px] border border-[#E2E8F0] shadow-2xl">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link
            to="/signup"
            className={`px-8 py-4 font-black rounded-2xl transition-colors shadow-[0_8px_24px_rgba(37,99,235,0.3)] ${requestId ? 'border border-[#E2E8F0] text-[#0F172A] hover:bg-[#F8FAFC]' : 'bg-[#2563EB] text-white hover:bg-[#1D4ED8]'}`}
          >
