...
function StatCard({ label, value, sub, accent }: { label: string; value: string | number; sub?: string; accent?: boolean }) {
  return (
    <div className="bg-white rounded-[20px] border border-[#E2E8F0] p-6 space-y-1 shadow-sm">
...
export default function AnalyticsPage() {
    ...
    return (
      <div className="p-8 max-w-5xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-28 animate-pulse bg-[#E2E8F0] rounded-[20px]" />
          ))}
        </div>
      </div>
    );
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-8 bg-[#F8FAFC] min-h-screen">
      {/* Header */}
      <div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {Object.keys(stats.requestsByStatus).length > 0 && (
          <div className="bg-white rounded-[20px] border border-[#E2E8F0] p-6 space-y-4 shadow-sm">
      ...
      {stats.totalRequests === 0 && (
        <div className="bg-white rounded-[20px] border border-[#E2E8F0] p-12 text-center space-y-3 shadow-sm">
