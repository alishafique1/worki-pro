...
export const getVerificationEmailContent: GetVerificationEmailContentFn = ({
  ...
  subject: "Verify your Worki email",
  text: `Click the link below to verify your email address and get started with Worki: ${verificationLink}`,
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 32px;">
      <h2 style="margin-bottom: 8px;">Welcome to Worki 👋</h2>
      ...
      <p style="color: #999; font-size: 12px;">If you didn't sign up for Worki, you can safely ignore this email.</p>
    </div>
  `,
});
...
export const getPasswordResetEmailContent: GetPasswordResetEmailContentFn = ({
  ...
  subject: "Reset your Worki password",
  text: `Click the link below to reset your Worki password: ${passwordResetLink}`,
  html: `
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 32px;">
      <h2 style="margin-bottom: 8px;">Password Reset</h2>
      <p style="color: #555;">We received a request to reset your Worki password. Click below to choose a new one.</p>
