    ...
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <input
          ...
          className="flex-1 min-w-[220px] px-3 py-1.5 text-sm rounded-lg bg-white border border-[#E2E8F0] text-[#0F172A] placeholder:text-[#94A3B8] outline-none focus:border-[#2563EB]"
        />
      </div>
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              ...
              {filtered.map((req: any) => {
                ...
                return (
                  <tr key={req.id} className="border-b border-[#E2E8F0] last:border-0 align-top">
                    ...
                    <td className="py-3 pr-4">
                      <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                        req.status === 'NEW' ? 'bg-[#FEF3C7] text-[#F59E0B]' :
                      ...
                      {!isAssigning && req.assignedProvider ? (
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="text-xs text-[#475569] underline hover:text-[#0F172A]"
                          >
                            Reassign
                          </button>
                        </div>
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          {errorMap[req.id] && (
                            <p className="text-xs text-red-500">{errorMap[req.id]}</p>
                          )}
                        </div>
                      )}
                    </td>
