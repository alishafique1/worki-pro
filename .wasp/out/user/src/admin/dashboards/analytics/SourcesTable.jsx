const SourcesTable = ({ sources, }) => {
    return (<div className="border-border bg-card shadow-default sm:px-7.5 rounded-sm border px-5 pb-2.5 pt-6 xl:pb-1">
      ...
      <div className="flex flex-col">
        ...
        {sources && sources.length > 0 ? (sources.map((source) => (<div className="border-border grid grid-cols-3 border-b">
