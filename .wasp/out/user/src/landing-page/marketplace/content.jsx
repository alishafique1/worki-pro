import { BadgeCheck, CalendarCheck, ClipboardList, Clock3, Hammer, Home, KeyRound, Layers, Bell, MapPin, MessageSquareText, Search, ShieldCheck, ShowerHead, Wifi, Zap, } from "lucide-react";
...
export const solutionSteps = [
    ...
    },
    {
        icon: <BadgeCheck className="size-5"/>,
        title: "Match",
        description: "We connect you with a verified local pro who's available today. No calling around.",
    },
    {
        icon: <CalendarCheck className="size-5"/>,
        title: "Book",
...
export const internalFeatures = [
    ...
    },
    {
        ...
        description: "Postal code and category details help The Helper understand where coverage is needed.",
    },
    {
        icon: <Clock3 className="size-5"/>,
        title: "Future internal assistance",
        description: "Automation may support internal request triage later, but it is not presented as a customer-facing promise.",
    },
];
export const trustFeatures = [
    {
        ...
        description: "Profiles can include business details, service categories, service areas, and approval status.",
    },
    {
        icon: <ClipboardList className="size-5"/>,
        title: "Service records",
        description: "Request and appointment history can stay tied to the customer account.",
    },
    {
        icon: <MessageSquareText className="size-5"/>,
        title: "Clear communication",
        description: "Booking details, messages, and status updates stay connected to the job.",
    },
    {
        icon: <MapPin className="size-5"/>,
        title: "Local-first marketplace",
        description: "The Helper starts city by city, building supply quality before scaling.",
    },
];
...
export const faqs = [
    ...
    },
    {
        ...
        answer: "Most homeowners get matched with a verified local pro within the hour of submitting. For urgent jobs like a broken AC or a leak, same-day service is often available. The system notifies nearby pros as soon as your request comes in.",
    },
    {
    ...
    },
    {
        ...
        answer: "You earn points automatically at each step. 500 pts when you submit a request. 500 pts when you book. 5,000 pts when your first job is completed. Refer a friend and both of you earn 500 pts when they submit their first request. Redeem as gift cards once you hit 10,000 pts (≈ $100).",
    },
    {
