...
export default function LandingPage() {
    ...
    aria - hidden;
    "true";
    className = "-mt-6 relative z-10 mx-4 rounded-2xl border border-[#E2E8F0] bg-white p-5 shadow-[0_24px_64px_rgba(15,23,42,0.12)]" >
...
>>>>>>> eloquent-mirzakhani-4c517b
    ...
    section >
        { /* ── REWARDS ───────────────────────────────────────────────────── */}
        < section;
    className = "bg-gradient-to-br from-[#1E3A8A] via-[#1D4ED8] to-[#2563EB] py-16 sm:py-20" >
        <Container>
    ...
    section >
        ...
        { /* ── PROVIDER CTA BAND ─────────────────────────────────────────── */}
        < section;
    className = "bg-white py-12 sm:py-16 border-t border-[#E2E8F0]" >
        <Container>
