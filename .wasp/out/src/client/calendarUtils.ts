 ...
 */
export function generateGoogleCalendarLink(event: CalendarEventParams): string {
 ...
 * Opens in a new tab to create the event.
 */
export function generateOutlookCalendarLink(event: CalendarEventParams): string {
  const params = new URLSearchParams({
    subject: event.title,
 ...
 */
function generateICSContent(event: CalendarEventParams): string {
 ...
 */
export function downloadICSFile(event: CalendarEventParams, filename = 'appointment.ics'): void {
