  ...
  return (
    <div ref={dropdownRef} className={`relative inline-block ${className}`}>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-[14px] border border-[#E2E8F0] bg-white px-3 py-2 text-xs font-bold text-[#2563EB] hover:border-[#2563EB] hover:bg-[#EFF6FF] transition-colors"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 z-20 mt-1.5 w-48 rounded-[14px] border border-[#E2E8F0] bg-white shadow-lg">
          <div className="py-1">
            <button
              type="button"
              onClick={handleGoogleClick}
              className="flex w-full items-center gap-2.5 px-4 py-2.5 text-left text-sm text-[#0F172A] hover:bg-[#F8FAFC] transition-colors"
            >
