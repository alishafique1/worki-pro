      ...
      <main className="pb-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-4">
            <Link
              to="/get-quotes?category=handyman&slug=handyman"
          ...
          <section className="w-full max-w-2xl mb-16" aria-label="Common handyman tasks">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {HANDYMAN_CHIPS.filter(chip => chip !== 'Something else').map(chip => (
                <Link
                  key={chip}
                  to={`/get-quotes?category=handyman&slug=handyman&problem=${encodeURIComponent(chip)}`}
