...
export default function PageSeo({
  ...
  useEffect(() => {
    ...
    function upsertStructuredData(data: object): () => void {
      const existingScript = document.querySelector<HTMLScriptElement>("script[data-seo-page='true']");
    ...
    cleanups.push(
      ...
      upsertMeta("[property='og:image']", 'content', resolvedOgImage),
    ...
    cleanups.push(
      ...
      upsertMeta("[name='twitter:image']", 'content', resolvedOgImage),
    );
