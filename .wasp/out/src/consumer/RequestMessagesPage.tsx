    ...
    <div className="flex flex-col max-w-3xl mx-auto min-h-[90vh] px-4 py-6 bg-[#F8FAFC]">
                ...
                >
                  ...
                  <p
                    className={`text-xs mt-1 ${
                      isConsumer ? "text-white/60 text-right" : "text-[#94A3B8]"
                    }`}
                  >
      ...
      <form onSubmit={handleSend} className="flex gap-3">
        <input
          ...
          disabled={sending}
          className="flex-1 px-5 py-3.5 rounded-[16px] border border-[#E2E8F0] bg-white text-[#0F172A] placeholder:text-[#94A3B8] focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB]/30 focus:outline-none transition-colors"
        />
        <button
          type="submit"
