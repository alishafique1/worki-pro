...
export default function ConsumerLayout({ children, user }: Props) {
      ...
      <div className="relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto">
        ...
        <header className="lg:hidden sticky top-0 z-10 flex w-full items-center gap-3 border-b border-[#E2E8F0] bg-white px-4 py-3 shadow-sm">
          <button
            ...
            className="flex h-8 w-8 flex-col items-center justify-center gap-1.5 rounded-lg border border-[#E2E8F0] bg-white p-1.5 hover:bg-[#F8FAFC] transition-colors"
          >
