...
export default function PrivacyPage() {
  return (
    <>
      <PageSeo
        title="Read Our Privacy Policy | The Helper"
        description="Understand exactly how The Helper collects, uses, and protects your personal data — and your rights under Canadian privacy law. Transparent, straightforward."
        ogTitle="Privacy Policy | The Helper"
        ogDescription="How The Helper collects, uses, and protects your data — and your rights under PIPEDA. Clear terms, no surprises."
        canonicalPath="/privacy"
        keywords="privacy policy, data protection, personal information, PIPEDA, Canadian privacy law, The Helper"
        structuredData={{
