...
export default function ApplianceLandingPage() {
  return (
    <>
      <PageSeo
        title="Appliance Repair in Mississauga, Brampton & GTA | The Helper"
        description="Same-day appliance repair in Mississauga, Brampton, Oakville & Burlington. Certified techs for fridges, washers, dryers, ovens, and dishwashers. All brands serviced. Get matched with verified pros."
        ogTitle="Same-Day Appliance Repair in Mississauga & GTA | The Helper"
        ogDescription="Book certified appliance repair techs in Mississauga, Brampton & the GTA. Fridges, washers, dryers, ovens - all brands, upfront pricing."
        canonicalPath="/appliance-repair"
        keywords="appliance repair Mississauga, fridge repair Brampton, washer repair Oakville, dryer repair Burlington, dishwasher repair GTA, appliance technician near me"
        structuredData={{
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      <LandingHeroBanner
        src="https://images.unsplash.com/photo-1626806787461-102c1bfaaea1?auto=format&fit=crop&w=1600&q=80"
        alt="Appliance repair technician fixing a washer"
      />
      <main className="pb-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-4">
            <Link
              to="/get-quotes?service=appliance-repair"
          ...
          <section className="w-full mb-24" aria-labelledby="brands-heading">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Samsung', 'LG', 'Whirlpool', 'GE', 'Maytag', 'Bosch', 'KitchenAid', 'Frigidaire', 'Kenmore', 'Miele'].map((brand) => (
                <span
                  key={brand}
          ...
          <section className="w-full mb-24" aria-labelledby="service-areas-heading">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Mississauga', 'Brampton', 'Oakville', 'Burlington', 'Milton', 'Hamilton'].map((area) => (
                <Link
                  key={area}
