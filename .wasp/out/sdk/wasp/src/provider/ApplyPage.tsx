  ...
  return (
    <>
      <PageSeo
        ...
        description="Join 50+ verified GTA pros. Get matched with homeowners in Milton, Oakville, Burlington who are ready to book. No bidding wars, no commission. Apply in 3 minutes."
        canonicalPath="/providers/apply"
        keywords="join contractor network, become service provider, plumber apply GTA, handyman apply, event services, website design apply, get more service leads"
      />
