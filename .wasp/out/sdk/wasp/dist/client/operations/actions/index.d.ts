...
export declare const addPortfolioPhoto: ActionFor<AddPortfolioPhoto_ext>;
export declare const removePortfolioPhoto: ActionFor<RemovePortfolioPhoto_ext>;
export declare const setProfilePhoto: ActionFor<SetProfilePhoto_ext>;
export declare const createBillingSetupSession: ActionFor<CreateBillingSetupSession_ext>;
...
export declare const disputeLeadFee: ActionFor<DisputeLeadFee_ext>;
export declare const moderateReview: ActionFor<ModerateReview_ext>;
export declare const upsertAdminCategory: ActionFor<UpsertAdminCategory_ext>;
export declare const deleteAdminCategory: ActionFor<DeleteAdminCategory_ext>;
...
export declare const resolveFeeDispute: ActionFor<ResolveFeeDispute_ext>;
