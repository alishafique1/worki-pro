...
export default function DiscoveryPage() {
    ...
    return (<div className="p-8 max-w-7xl mx-auto min-h-[80vh]">
      ...
      {isLoading ? (<div className="space-y-10">
          ...
          {selectedArea && (<button onClick={() => setSelectedArea('')} className="mt-4 px-5 py-2 bg-[#2563EB] text-white font-bold rounded-[16px] text-sm hover:bg-[#1D4ED8] transition-colors">
              Clear Area Filter
            </button>)}
        </div>) : (<>
