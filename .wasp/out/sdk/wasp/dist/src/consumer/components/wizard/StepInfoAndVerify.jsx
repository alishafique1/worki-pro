...
export default function StepInfoAndVerify({ state, update, onBack, onNext }) {
    ...
    return (<div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <input type="text" className={`${inputClass} uppercase`} placeholder="L9T 2X5" value={postal} onChange={e => { setPostal(e.target.value); setFieldError(null); }} maxLength={7}/>
