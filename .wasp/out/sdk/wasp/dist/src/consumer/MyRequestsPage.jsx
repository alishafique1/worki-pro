...
export default function MyRequestsPage() {
    ...
    return (<div className="mx-auto max-w-5xl space-y-6 p-6 bg-[#F8FAFC] min-h-screen">
      ...
      {isLoading && (<div className="space-y-4">
          {[0, 1, 2].map((item) => (<div key={item} className="animate-pulse rounded-[24px] border border-[#E2E8F0] bg-white p-5 space-y-5">
              ...
              <div className="grid gap-3 sm:grid-cols-4">
                {[0, 1, 2, 3].map((s) => (<div key={s} className="flex items-center gap-2">
