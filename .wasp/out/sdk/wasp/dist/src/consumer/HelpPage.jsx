...
import { MessageSquare, BookOpen, CreditCard, ShieldCheck, CalendarCheck, Star, ArrowRight, Users, Zap, } from 'lucide-react';
const consumerFaqs = [
    {
    ...
    },
    {
        ...
        answer: 'Once you submit a request, a verified provider in your area is notified immediately. You should hear back within a few hours during business hours.',
    },
    {
        question: 'Are providers background-checked?',
        answer: 'Provider onboarding includes verification of business details, credentials, and service areas. All providers must meet TheHelper\'s onboarding standards before accepting jobs.',
    },
    {
        question: 'How do I track my service request?',
        answer: 'Go to "My Requests" in your dashboard. You\'ll see the current status of each request, any appointments scheduled, and messages from your provider.',
    },
    {
        question: 'How do appointments work?',
        answer: 'Once a provider accepts your request, they can schedule an appointment time. You\'ll see it in your dashboard and receive any status updates as the job progresses.',
    },
    {
        question: 'How do rewards points work?',
        answer: 'You earn points on completed services. Points appear in your Rewards wallet and can be redeemed for account credits toward future jobs. Check your points balance on the Rewards page.',
    },
    {
        question: 'How do I earn and use my referral code?',
        answer: 'Go to the Referral page to find your unique code. Share it with friends. When they complete their first service, you both earn reward points automatically.',
    },
    {
        question: 'Can I message my provider?',
        answer: 'Yes. Each active request has a messaging thread. You can send updates, ask questions, or clarify details directly from the request detail view.',
    },
    {
        question: 'What if I need to cancel or reschedule?',
        answer: 'Contact your provider directly through the messaging thread on your request. If you need immediate help, reach out via the Contact page.',
    },
    {
        question: 'How do I leave a review?',
        answer: 'After a service is completed, you can rate your experience on the request detail page. Your feedback helps other homeowners choose trusted providers.',
    },
    {
        question: 'What service categories are available?',
        answer: 'TheHelper covers HVAC, handyman, plumbing, electrical, appliance repair, and smart home installation. Browse all available categories on the Services page.',
    },
    {
        question: 'What areas do you serve?',
        answer: 'TheHelper currently serves Milton, Oakville, Burlington, Mississauga, Brampton, Hamilton, Toronto, and surrounding GTA areas. Coverage depends on provider availability in your neighbourhood.',
    },
];
const quickLinks = [
    {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-[#E2E8F0] rounded-[20px] p-5">
              ...
              <div className="space-y-3">
                {quickLinks.map((link) => (<Link key={link.href} to={link.href} className="flex items-start gap-3 p-3 rounded-[14px] bg-[#F8FAFC] hover:bg-[#EFF6FF] transition-colors group">
            ...
            <div className="bg-white border border-[#E2E8F0] rounded-[20px] p-5">
              ...
              <div className="space-y-2.5">
                {trustItems.map((item) => (<div key={item.text} className="flex items-center gap-2.5">
            ...
            <div className="bg-[#2563EB] rounded-[20px] p-5">
              ...
              <Link to="/contact" className="inline-flex items-center gap-1.5 bg-white text-[#2563EB] text-sm font-bold px-4 py-2.5 rounded-[14px] hover:bg-[#EFF6FF] transition-colors">
                Contact Support
...
//# sourceMappingURL=HelpPage.jsx.map