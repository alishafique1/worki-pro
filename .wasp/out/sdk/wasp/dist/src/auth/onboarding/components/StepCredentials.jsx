...
export default function StepCredentials({ selectedCategoryIds, licenceNumber, insuranceInfo, wsibClearanceNumber, onChange, }) {
    ...
    return (<div className="space-y-4">
      ...
      <div>
        ...
        <input type="text" className={inputClass} placeholder="e.g. 1234567" value={licenceNumber} onChange={(e) => onChange('licenceNumber', e.target.value)}/>
      ...
      <div>
        ...
        <input type="text" className={inputClass} placeholder="e.g. Intact — policy CGL-123456, or a link to your certificate" value={insuranceInfo} onChange={(e) => onChange('insuranceInfo', e.target.value)}/>
      ...
      <div>
        ...
        <input type="text" className={inputClass} placeholder="e.g. 1234567" value={wsibClearanceNumber} onChange={(e) => onChange('wsibClearanceNumber', e.target.value)}/>
        <p className="text-xs text-[#475569] mt-1">
...
//# sourceMappingURL=StepCredentials.jsx.map