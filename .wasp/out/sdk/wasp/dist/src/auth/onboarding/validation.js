...
export const isValidCanadianPhone = (v) => CANADIAN_PHONE.test(v.trim());
export const isValidCanadianPostal = (v) => CA_POSTAL.test(v.trim());
export const isGtaPostal = (v) => GTA_POSTAL_PREFIX.test(v.trim());
/**
 ...
 */
export function validateOnboarding(input, opts = {}) {
    if (!input.role)
