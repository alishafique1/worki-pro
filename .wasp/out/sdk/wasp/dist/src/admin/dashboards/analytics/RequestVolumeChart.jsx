...
const RequestVolumeChart = ({ data, isLoading }) => {
    ...
    return (<div className="px-2 pb-2">
      <ReactApexChart options={options} series={[{ name: "Requests", data: counts }]} type="area" height={300}/>
    </div>);
};
export default RequestVolumeChart;
//# sourceMappingURL=RequestVolumeChart.jsx.map