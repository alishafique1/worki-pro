...
export function NotFoundPage() {
    ...
    return (<div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6">
      <div className="text-center">
        ...
        <WaspRouterLink to={user ? routes.DemoAppRoute.to : routes.LandingPageRoute.to} className="inline-flex items-center gap-2 rounded-full bg-[#2563EB] px-8 py-3.5 text-base font-semibold text-white shadow-[0_8px_24px_rgba(37,99,235,0.3)] hover:bg-[#1D4ED8] transition-colors">
          Go Back Home
        </WaspRouterLink>
      </div>
    </div>);
