    ...
    return (<div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-slate-900 text-white py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link to={`/get-quotes?category=${category.id}&slug=${category.slug}`} className="inline-block px-10 py-4 bg-blue-600 text-white font-bold rounded-full text-lg hover:bg-blue-700 transition-colors shadow-[0_8px_24px_rgba(37,99,235,0.3)]">
            Get Help →
          </Link>
        </div>
      </section>
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        ...
        ].map(step => (<div key={step.n} className="bg-white border border-slate-200 rounded-2xl p-6 text-center">
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {areas.map(area => (<Link key={area.slug} to={`/services/${categorySlug}/${area.slug}`} className="px-5 py-2.5 bg-white border border-slate-200 rounded-full text-sm font-semibold text-slate-900 hover:border-blue-600 hover:text-blue-600 transition-colors">
              {area.name}
            </Link>))}
        </div>
      </section>
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (<div key={i} className="bg-white border border-slate-200 rounded-2xl p-6">
