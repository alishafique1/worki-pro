...
export default function HowRewardsWorkPage() {
    return (<>
      <PageSeo title="How Rewards Work — Earn 5% Cash Back on Every Home Service | The Helper" description="Earn $60 on your first completed job, then 5% cash back on every job after. Points never expire. Redeem for Amazon gift cards, Starbucks, or service credits at $100 minimum." ogTitle="Earn Real Cash Back on Every Home Service Job | The Helper" ogDescription="Stack 5% cash back on top of your credit card points. $60 bonus on your first job. Redeem for Amazon, Starbucks, or service credits." canonicalPath="/how-rewards-work" keywords="home services cash back, rewards program GTA, earn on home repairs, HVAC cash back, plumbing rewards, handyman loyalty" structuredData={createFaqSchema(rewardsFaqs)}/>
    <div className='min-h-screen bg-[#F8FAFC]'>
      <main className='max-w-5xl mx-auto px-6 lg:px-8 pt-24 pb-32'>
        ...
        <div className='text-center'>
          <Link to='/get-quotes' className='inline-block px-14 py-6 bg-[#2563EB] text-white font-black rounded-[30px] text-xl hover:bg-[#1D4ED8] transition-colors hover:scale-105'>
