...
export default function HowRewardsWorkPage() {
    return (<>
      <PageSeo title="The Helper Rewards | Earn 5% Cashback on Home Services in GTA" description="Earn up to $60 back on your first home service job and 5% cashback on every job after. Stack The Helper rewards on top of your credit card points. Redeem for Amazon, Starbucks, or service credits." ogTitle="Earn 5% Cashback on Home Services | The Helper Rewards" ogDescription="The Helper stacks 5% cashback on top of your credit card points. Earn up to $60 on your first job - HVAC, plumbing, electrical and more in the GTA." canonicalPath="/how-rewards-work" keywords="home services rewards, cashback home repair, earn rewards HVAC, plumbing rewards, home service loyalty program" structuredData={createFaqSchema(rewardsFaqs)}/>
    <div className='min-h-screen bg-[#F8FAFC]'>
      <main className='max-w-5xl mx-auto px-6 lg:px-8 pt-24 pb-32'>
        ...
        <div className='text-center'>
          <Link to='/request-service' className='inline-block px-14 py-6 bg-[#2563EB] text-white font-black rounded-[30px] text-xl hover:bg-[#1D4ED8] transition-colors hover:scale-105'>
