...
import { CheckCircle2, CreditCard, Gift, TrendingUp, Coffee, Home } from 'lucide-react';
const rewardsFaqs = [
    {
...
export default function HowRewardsWorkPage() {
    return (<>
      <PageSeo title="How Rewards Work — Earn Points on Every Home Service | The Helper" description="Earn up to 6,000 points on your first completed job, then 5% back on every job after. Points never expire. Redeem for Amazon gift cards, Starbucks, or service credits at 10,000 points." ogTitle="Earn Points on Every Home Service Job | The Helper" ogDescription="Stack 5% points back on every home service job. 6,000 points on your first completed job. Redeem for Amazon, Starbucks, or service credits." canonicalPath="/how-rewards-work" keywords="home services rewards, points program GTA, earn on home repairs, HVAC rewards, plumbing loyalty, handyman rewards" structuredData={createFaqSchema(rewardsFaqs)}/>
      ...
      <main className='max-w-5xl mx-auto px-6 lg:px-8 pt-24 pb-32'>
        ...
        <div className='mb-6'>
          ...
          <div className='space-y-6'>
            {FIRST_JOB_TIERS.map((tier) => (<div key={tier.step} className='bg-white rounded-[32px] border border-[#E2E8F0] p-10 flex flex-col md:flex-row items-start md:items-center gap-8'>
        ...
        ].map(r => (<div key={r.label} className='p-6 bg-[#F8FAFC] rounded-2xl border border-[#E2E8F0]'>
        ...
        <div className='text-center'>
          <Link to='/get-quotes' className='inline-block px-14 py-6 bg-[#2563EB] text-white font-black rounded-[30px] text-xl hover:bg-[#1D4ED8] transition-colors hover:scale-105 shadow-[0_8px_24px_rgba(37,99,235,0.3)]'>
...
//# sourceMappingURL=HowRewardsWorkPage.jsx.map