...
import { CheckCircle2, Gift, Home, Lightbulb, MapPin, ShieldCheck, Smartphone, Star, Target, Users, Wrench, Zap, } from 'lucide-react';
...
function StarRating({ rating }) {
    return (<div className="flex gap-0.5">
      {[1, 2, 3, 4, 5].map((star) => (<span key={star} className={star <= rating ? 'text-[#F59E0B]' : 'text-[#E2E8F0]'}>
          ★
        </span>))}
    </div>);
}
export default function AreaLandingPage() {
    ...
    return (<>
      <PageSeo title={metaContent.title} description={metaContent.description} ogTitle={metaContent.ogTitle} ogDescription={metaContent.ogDescription} canonicalPath={`/areas/${areaSlug}`} keywords={metaContent.keywords} structuredData={createLocalBusinessSchema({
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <section className="pt-20 pb-24 px-6">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          <h1 className="text-5xl sm:text-6xl font-black tracking-tighter leading-[0.95] mb-8 max-w-4xl text-[#0F172A]">
            {area.localContent ? (area.localContent.heroHeadline) : (<>
      ...
      {area.localContent && (<section className="py-12 px-6 bg-white border-y border-[#E2E8F0]">
      ...
      {area.localContent && (<section className="py-20 px-6 bg-white">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {area.localContent.testimonials.map((testimonial, idx) => (<div key={idx} className="bg-[#F8FAFC] rounded-[32px] border border-[#E2E8F0] p-8 flex flex-col">
      ...
      {area.localContent && (<section className="py-20 px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {area.localContent.neighborhoods.map((hood) => (<span key={hood} className="px-3 py-1.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-full text-sm text-[#475569]">
                        {hood}
                      </span>))}
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {area.localContent.localLandmarks.map((landmark) => (<span key={landmark} className="px-3 py-1.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-full text-sm text-[#475569]">
                        {landmark}
                      </span>))}
                  </div>
                </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {HOW_IT_WORKS.map(({ step, title, desc, icon }) => (<div key={step} className="bg-[#F8FAFC] rounded-[32px] border border-[#E2E8F0] p-8 flex flex-col gap-4 animate-in fade-in duration-500">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {TRUST_BADGES.map(({ icon, label }) => (<div key={label} className="bg-white rounded-[24px] border border-[#E2E8F0] p-6 flex flex-col items-center gap-3 text-center hover:border-[#BFDBFE] transition-colors">
                {icon}
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            return (<Link key={city} to={`/areas/${slug}`} className="group p-6 bg-[#F8FAFC] rounded-2xl border border-[#E2E8F0] hover:border-[#BFDBFE] hover:bg-white transition-all">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            return isInData ? (<Link key={city} to={`/areas/${slug}`} className="px-5 py-2.5 rounded-full bg-white border border-[#E2E8F0] text-sm font-bold hover:border-[#BFDBFE] hover:text-[#2563EB] hover:-translate-y-0.5 transition-all">
                    {city} →
                  </Link>) : (<span key={city} className="px-5 py-2.5 rounded-full bg-[#F8FAFC] border border-[#E2E8F0] text-sm font-bold text-[#475569]">
                    {city}
                  </span>);
        })}
          </div>
...
//# sourceMappingURL=AreaLandingPage.jsx.map