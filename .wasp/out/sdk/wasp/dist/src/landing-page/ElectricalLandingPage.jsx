...
export default function ElectricalLandingPage() {
    return (<>
      <PageSeo title="Electrician in Milton, Oakville & Burlington | Licensed Electrical Services" description="ESA-certified electricians for panel upgrades, EV charger installation, pot lights, and electrical repairs in Milton, Oakville & Burlington. Get matched with verified, licensed pros." ogTitle="Licensed Electricians in Milton, Oakville & Burlington | The Helper" ogDescription="Find trusted electricians for panel upgrades, EV charger installation, and electrical repairs in the GTA. ESA-certified where required, vetted pros." canonicalPath="/electrical" keywords="electrician Milton, electrical services Oakville, EV charger installation Burlington, panel upgrade GTA, pot lights installation, licensed electrician near me" structuredData={{
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      <LandingHeroBanner src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=1600&q=80" alt="Certified electrician working on a panel in Burlington"/>
      <main className="pb-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-4">
            <Link to="/get-quotes?service=electrical" className="px-10 py-5 bg-[#2563EB] text-white font-black rounded-3xl text-lg hover:bg-[#1D4ED8] transition-all hover:-translate-y-1 shadow-[0_8px_24px_rgba(37,99,235,0.3)]">
          ...
          <section className="w-full max-w-2xl" aria-labelledby="faq-heading">
            ...
            <div className="rounded-2xl border border-[#E2E8F0] bg-white px-6">
              {electricalFaqs.map((faq) => (<FaqItem key={faq.question} question={faq.question} answer={faq.answer}/>))}
            </div>
          </section>
        </div>
      </main>
...
//# sourceMappingURL=ElectricalLandingPage.jsx.map