...
export default function ProviderLandingPage() {
    return (<>
      <PageSeo title="Get Booking-Ready Leads. No Bidding Wars. | The Helper Pro Network" description="Stop paying for leads that never convert. The Helper matches you with GTA homeowners who submitted a specific request and are ready to book. Pay only when the job closes." ogTitle="Get Booking-Ready Leads. No Bidding Wars. | The Helper Pro Network" ogDescription="Every lead is a homeowner who submitted a specific request and is ready to book. No bidding wars, no commission. GTA coverage. Pay only when the job closes." canonicalPath="/providers" keywords="home service leads GTA, contractor leads Milton, HVAC leads Oakville, plumber leads Burlington, get more customers trades, home service marketing" structuredData={{
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      <main className="pb-20">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link to="/providers/apply" className="px-8 py-4 bg-[#2563EB] text-white font-black rounded-2xl text-base hover:bg-[#1D4ED8] transition-all hover:-translate-y-0.5 shadow-[0_8px_24px_rgba(37,99,235,0.3)]">
                  Apply as a Pro →
                </Link>
              </div>
              <div className="mt-6 flex flex-wrap gap-x-6 gap-y-2 text-sm text-[#475569]">
                {['No bidding wars', 'GTA coverage', 'Free to apply'].map(item => (<span key={item} className="flex items-center gap-1.5">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-80 lg:h-96">
              <img src="https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&w=900&q=80" alt="Professional contractor at work" className="w-full h-full object-cover"/>
        ...
        ].map((feature) => (<div key={feature.title} className="p-10 bg-white rounded-[40px] border border-[#E2E8F0] hover:border-[#2563EB] transition-colors text-left shadow-sm">
