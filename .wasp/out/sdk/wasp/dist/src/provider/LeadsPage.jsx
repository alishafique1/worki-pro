            ...
            return (<div key={lead.id} className="rounded-[18px] border border-[#E2E8F0] bg-white shadow-sm p-6 transition-all hover:border-[#BFDBFE]">
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {isClaimed && (<span className="px-3 py-1 rounded-full border text-xs font-bold border-green-200 text-green-700 bg-green-50">
                      Claimed
                    </span>)}
                </div>
              ...
              {!isClaimed ? (<div className="flex items-center gap-3">
                  <button onClick={() => handleClaim(lead.id)} disabled={isClaiming} className="px-6 py-2.5 bg-[#2563EB] text-white text-sm font-black rounded-[14px] hover:bg-[#1D4ED8] disabled:opacity-50 transition-all">
