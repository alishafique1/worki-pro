...
router.post(
  ...
  defineHandler(
    (
      req: Parameters<typeof _wasprequestOtpfn>[0] & { user: AuthUserData | null },
      res: Parameters<typeof _wasprequestOtpfn>[1],
    ) => {
      const context = {
...
router.post(
  ...
  defineHandler(
    (
      req: Parameters<typeof _waspverifyOtpfn>[0] & { user: AuthUserData | null },
      res: Parameters<typeof _waspverifyOtpfn>[1],
    ) => {
      const context = {
        user: makeAuthUserIfPossible(req.user),
        entities: {
...
router.post(
  ...
  defineHandler(
    (
      req: Parameters<typeof _waspcalcomWebhookfn>[0] & { user: AuthUserData | null },
      res: Parameters<typeof _waspcalcomWebhookfn>[1],
    ) => {
      const context = {
        user: makeAuthUserIfPossible(req.user),
        entities: {
...
router.post(
  ...
  defineHandler(
    (
      req: Parameters<typeof _wasptwilioWebhookfn>[0] & { user: AuthUserData | null },
      res: Parameters<typeof _wasptwilioWebhookfn>[1],
    ) => {
      const context = {
        user: makeAuthUserIfPossible(req.user),
        entities: {
...
router.post(
  ...
  defineHandler(
    (
      req: Parameters<typeof _waspghlWebhookfn>[0] & { user: AuthUserData | null },
      res: Parameters<typeof _waspghlWebhookfn>[1],
    ) => {
      const context = {
        user: makeAuthUserIfPossible(req.user),
        entities: {
