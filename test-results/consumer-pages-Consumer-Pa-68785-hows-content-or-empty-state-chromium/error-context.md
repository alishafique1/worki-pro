...
- Name: consumer-pages.spec.ts >> Consumer Pages — MyRequestsPage & ReferralPage >> MyRequestsPage shows content or empty state
- Location: tests/e2e/consumer-pages.spec.ts:49:3
...
Locator: getByText(/you have no active requests yet/i).or(getByRole('heading', { name: /my bookings & repairs/i }))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/you have no active requests yet/i).or(getByRole('heading', { name: /my bookings & repairs/i }))
