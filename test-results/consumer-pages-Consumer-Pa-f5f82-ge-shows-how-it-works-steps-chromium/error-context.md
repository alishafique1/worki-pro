...
- Name: consumer-pages.spec.ts >> Consumer Pages — MyRequestsPage & ReferralPage >> ReferralPage shows how-it-works steps
- Location: tests/e2e/consumer-pages.spec.ts:78:3
...
Locator: getByRole('heading', { name: /how it works/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /how it works/i })
