...
- Name: consumer-pages.spec.ts >> Consumer Pages — MyRequestsPage & ReferralPage >> MyRequestsPage renders the page heading
- Location: tests/e2e/consumer-pages.spec.ts:44:3
...
Locator: getByRole('heading', { name: /my bookings & repairs/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /my bookings & repairs/i })
