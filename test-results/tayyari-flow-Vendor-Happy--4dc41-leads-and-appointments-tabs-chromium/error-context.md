...
- Name: tayyari-flow.spec.ts >> Vendor Happy Path >> Provider dashboard shows leads and appointments tabs
- Location: tests/e2e/tayyari-flow.spec.ts:108:3
