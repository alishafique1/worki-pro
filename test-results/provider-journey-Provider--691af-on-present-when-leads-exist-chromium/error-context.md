...
- Name: provider-journey.spec.ts >> Provider — Authenticated Dashboard >> /provider/leads — claim lead button present when leads exist
- Location: tests/e2e/provider-journey.spec.ts:216:3
