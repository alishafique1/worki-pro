...
- Name: consumer-pages.spec.ts >> Consumer Pages — MyRequestsPage & ReferralPage >> ReferralPage renders the referral heading
- Location: tests/e2e/consumer-pages.spec.ts:63:3
...
Locator: getByRole('heading', { name: /refer a friend/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /refer a friend/i })
