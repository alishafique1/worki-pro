...
- Name: consumer-journey.spec.ts >> Consumer — Request Service (get-quotes) >> get-quotes wizard — user can select a service category
- Location: tests/e2e/consumer-journey.spec.ts:376:3
