...
- Name: tayyari-flow.spec.ts >> Couple (Consumer) Happy Path >> Dashboard shows rewards widget and active jobs section
- Location: tests/e2e/tayyari-flow.spec.ts:57:3
...
Call log:
  - waiting for getByRole('button', { name: /log in/i })
    - locator resolved to <button type="submit" class="_submitButton_1s79h_69">Log in</button>
...
- generic [ref=e1]:
  - generic [ref=e2]:
        ...
        - generic [ref=e32]:
          ...
          - generic [ref=e48]:
            - generic [ref=e49]:
              ...
              - textbox [ref=e51]: test@worki.ai
            - generic [ref=e52]:
              - generic [ref=e53]: Password
              - textbox [ref=e54]: Password123!
            - button "Log in" [ref=e56] [cursor=pointer]
        - generic [ref=e57]:
          - paragraph [ref=e58]:
            - text: Don't have an account?
            - link "Sign up free" [ref=e59] [cursor=pointer]:
              - /url: /signup
          - paragraph [ref=e60]:
    ...
    - region "Notifications (F8)":
      - list
  - img
  - dialog "We use cookies" [ref=e62]:
    - generic [ref=e63]:
      - generic [ref=e64]:
        - heading "We use cookies" [level=2] [ref=e65]
        - paragraph [ref=e66]: We use cookies primarily for analytics to enhance your experience. By accepting, you agree to our use of these cookies. You can manage your preferences or learn more about our cookie policy.
      - generic [ref=e68]:
        - button "Accept all" [ref=e69] [cursor=pointer]
        - button "Reject all" [ref=e70] [cursor=pointer]
    - generic [ref=e73]:
