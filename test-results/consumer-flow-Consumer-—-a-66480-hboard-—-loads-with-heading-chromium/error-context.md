...
- Name: consumer-flow.spec.ts >> Consumer — authenticated flow >> /dashboard — loads with heading
- Location: tests/e2e/consumer-flow.spec.ts:56:3
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e31]:
        ...
        - generic [ref=e38]:
          ...
          - button "Send code →" [disabled] [ref=e42]
          - paragraph [ref=e43]:
            - button "Sign in with password" [ref=e44]
        - paragraph [ref=e46]:
          - text: Don't have an account?
          - link "Create one — it's free" [ref=e47] [cursor=pointer]:
            - /url: /signup
